...
class EditYangBaru extends StatefulWidget {
  DocumentSnapshot docid;
  EditYangBaru({required this.docid});
  
  @override
  State<EditYangBaru> createState() => _EditYangBaruState();
}

class _EditYangBaruState extends State<EditYangBaru> {
