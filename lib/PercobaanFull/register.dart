...
class RegisterScreen12 extends StatefulWidget {
  @override
  State<RegisterScreen12> createState() => _RegisterScreen12State();
}

class _RegisterScreen12State extends State<RegisterScreen12> {
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            child: Text(' Masuk', style: TextStyle(color: Color(0xff566F9F)),),
                            onTap: () {
