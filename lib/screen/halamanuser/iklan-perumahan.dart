...
class TambahIklanPerumahan extends StatefulWidget {
  const TambahIklanPerumahan({super.key});

  @override
  State<TambahIklanPerumahan> createState() => _TambahIklanPerumahanState();
}

class _TambahIklanPerumahanState extends State<TambahIklanPerumahan> {
                    ...
                    child: ElevatedButton(
                      onPressed: (){
                       if (controllerJudul.text == "" ||
                                  ...
                                  controllerKamarMandi.text == "" || controllerTipe.text=="") {
                        ...
                        FirebaseStorage.instance
                                  ...
                                  users.add({
                                    ...
                                    'luasBangunan': int.parse(controllerLuasBangunan.text),
                                    'kamarMandi': value2,
                                    'kamarTidur': value1,                            
                                    'alamatLokasi': controllerAlamatLokasi.text,
                                    'sumberAir':controllerSumberAir.text,
                                    'listrik': int.parse(controllerListrik.text),
                                    'sertifikat': value,
                                    'deskripsi': controllerDeskripsi.text,
                                    'fieldGambar': imageUrl,
                                    'typeProperti': controllerTipe.text,
                                    'userId': uid
                                  }).then((value) {
