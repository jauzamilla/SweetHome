...
class KategoriPerumahan extends StatefulWidget {
  const KategoriPerumahan({super.key});

  @override
  State<KategoriPerumahan> createState() => _KategoriPerumahanState();
}

class _KategoriPerumahanState extends State<KategoriPerumahan> {
  ...
  final  _categories =
      FirebaseFirestore.instance.collection('categories').where('tipeKategori', isEqualTo: 'Perumahan');
  @override
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    ...
                    onTap: (){
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=> DetailPerumahan(docid: snapshot.data!.docs[index],)));
                    },
                  );
                });
          }),
