...
class KategoriTanah extends StatefulWidget {
  const KategoriTanah({super.key});

  @override
  State<KategoriTanah> createState() => _KategoriTanahState();
}

class _KategoriTanahState extends State<KategoriTanah> {
  ...
  final  _categories =
      FirebaseFirestore.instance.collection('categories').where('tipeKategori', isEqualTo: 'Tanah');
  @override
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    ...
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: ((context) => DetailTanah(docid: snapshot.data!.docs[index],))));
                    },
                  );
                });
          }),
