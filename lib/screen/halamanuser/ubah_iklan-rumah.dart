...
class UbahIklanRumah extends StatefulWidget {
  ...
  @override
  State<UbahIklanRumah> createState() => _UbahIklanRumahState();
}

class _UbahIklanRumahState extends State<UbahIklanRumah> {
  ...
  void initState() {
    ...
    luasBangunan = TextEditingController(
        text: widget.docid.get('luasBangunan').toString());
    listrik =
        TextEditingController(text: widget.docid.get('listrik').toString());
  ...
  Widget build(BuildContext context) {
    ...
    final users = firestore
        ...
        .where('tipeKategori', isEqualTo: 'Rumah');
    return Scaffold(
        appBar: AppBar(
          elevation: 0,
