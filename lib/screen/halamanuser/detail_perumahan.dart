...
class DetailPerumahan extends StatefulWidget {
  ...
  DetailPerumahan({Key? key, required this.docid}) : super(key: key);
  @override
  State<DetailPerumahan> createState() => _DetailPerumahanState();
}
              ...
              child: Column(
                  ...
                  children: [
                    BodyDetailPerumahan(
                        ...
                        harga: 'Rp.' + widget.docid.get('price'),
                        ...
                        tipe: widget.docid.get('typeProperti'),
